//! 256-bit integer multiply-divide helpers for the per-bin swap step.
//!
//! Verbatim port of `MeteoraAg/dlmm-sdk` `commons/src/math/u128x128_math.rs`.
//! `Rounding` is locally redeclared (upstream pulls it from the anchor-
//! generated `dlmm::types`) but the discriminants and behavior match.
